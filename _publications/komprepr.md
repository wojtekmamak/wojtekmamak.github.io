...
permalink: /publication/komprepr
excerpt: 'I argue for the need to conceptualize representations as information-compressor - a view that has surprisingly eluded the debates on representational properties.'    
date: 2099-11-09
venue: "Draft (submitted to 'Minds & Machines')"
# slidesurl: 'http://academicpages.github.io/files/slides1.pdf'
paperurl: '/files/komprepr.pdf'
citation: 'Mamak, W (draft). Representing As Compressing. Bridging the Biological and Artificial Perceptual Systems: A Case for Information-based Explanations in Cognitive Science.'
---

Psychology, statistics, computer science, machine learning, 
