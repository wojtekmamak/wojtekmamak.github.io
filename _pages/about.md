...
permalink: /
title: "About"
excerpt: "Philosophy in/of Cognitive Science + History of Data & Stats"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
<div class="research-interests">
  <div class="interest-card">
    <h3>🧠 Philosophy of Cognitive Science</h3>
    <p>Neural underpinnings of (structural) representation, format, inference and other key philosophy of mind concepts. Modes of explanation in cognitive neuroscience.</p>
  </div>
  
  <div class="interest-card">
    <h3>💾 Information Theory & Neuroscience</h3>
    <p>Semantic information, generativity, compression, and the cellular foundations of mental life via the 'cooperative neuron' paradigm.</p>
  </div>
  
  <div class="interest-card">
    <h3>📊 History of Statistics & Data</h3>
    <p>The emergence of modern statistics and quantification (1831-1939), particularly as their role in the cognitive transformation in Poland's intellectual history - a process I call 'the shift in the standard of rationality'</p>
  </div>
  
  <div class="interest-card">
    <h3>🎓 Cognitive History</h3>
    <p>The evolution of mentalities, conceptual systems, and ideals of rationality across time and cultures. Ideally investigated with the god-sends that are computational methods.</p>
  </div>
</div>
...
<div class="section-image">
  ...
  <figcaption> I am a strong believer in consistency in explaining artificial and biological systems on equal terms, but simulating sports excitement is sacrilege. When we pass 2.0, I call for the Butlerian Jihad. (comic by Tom Gauld)</figcaption>
</div>

### History of Quantification

On the history of science side of things, I am quite bewitched by the omnipresence and deep trust in numbers, stats, and data in pretty much all domains of life nowadays. Hence, as a historian, I wish to understand how and why this came to be. Following brilliant scholars of this problem (especially Ted Porter, Ian Hacking, and Lorraine Daston), I call this process "quantification." My research is geared towards pinpointing both the causal mechanisms of this emergence and its ramifications. Naturally, I tend to focus a lot on the case of Polish history (from the 19th century onwards) within this big picture, which is quite a quirky (and as such—highly instructive) case in the grand scheme of the history of stats. It's also absolutely unexplored so far, which makes it exciting.

In particular, I want to argue for the shift in "standards of rationality" brought about by this flood of metrics and calculations — a central thesis of my ongoing book-length project in the Cognitive History of statistical thinking. For this purpose, I combine methods from the history and philosophy of science, the history of ideas, and STS, alongside quantitative tools (the irony is not lost on me here). You can perhaps now sense why I strongly believe that history and philosophy of science are not disconnected fields of study for me, but deeply integrated ones (hence my investment in the Integrated HPS approach).

<div class="section-image">
  <img src="/images/guskarty1.jpg" alt="Infografiki">
...
<div class="projects-list">
  <ul>
    <li><a href="/portfolio/generativity"><strong>Defining Generativity:</strong></a> Distinguishing genuine information generation from faux-generativity in AI and cognitive systems.</li>
    <li><a href="/publication/meaningmatching"><strong>Representation & Compression:</strong></a> How compression mechanisms enable neural systems to efficiently preserve and process information.</li>
    <li><a href="/publication/recphilofsci"><strong>Mapping the Cooperative Neuron:</strong></a> Exploring the philosophical consequences of William Phillips' two-point neural architectures.</li>
    <li><a href="/portfolio/sustainability"><strong>To Foresee and Forestall:</strong></a> Tracing the history of statistics within sustainability sciences.</li>
    <li><a href="/portfolio/numerical-advantage"><strong>Przewaga liczebna (<i>The Numerical Advantage</i>):</strong></a> A forthcoming popular science book on how we learned to love counting. [<i>In Polish</i>]</li>
    <li><a href="/portfolio/shift"><strong>Cognitive History of Data in Poland (1831-1939):</strong></a> Tracing how statistical thinking and quantification transformed Polish intellectual and public life during modernization.</li>
    <li><a href="/portfolio/atlas-quantification"><strong>Atlas of Quantification:</strong></a> An open-ended almanac of the spread and evolution of quantitative reasoning across domains and cultures. Very much work in progess; intended for some interactive display and collaborative curating in the future</li>
  </ul>
</div>
...
<div class="section-image">
  ...
  <figcaption>Teaching philosophy of cognitive science in Ulaanbaatar, Mongolia</figcaption>
</div>
...
When not busy doing history and philosophy of science (and that is quite a chunk of my time, admittedly), I consume an unholy amount of sports, chiefly soccer. Some years ago, American football also became a revelation. Apart from regular game-watching, I am particularly interested in how stats are introduced into sports (and their limitations).

Travelling the world is certainly my favourite pastime. From the most lackluster Polish backwaters to faraway corners - I sign up for a trip whenever possible. My hopeless intention is to visit all the 193 countries (counter now at 115/193) someday. Which is decisively arbitrary and rather shallow - I concede. To make matters even worse, I'm always hellbent on bringing fridge magnets back home.  

Other things I hugely enjoy include <i>playing</i> football, too, chess (used to be really decent!), video games, electronic music and memetics. I also care a lot about experimenting with food from around the globe (both as a *producer and a consumer*—in teleosemantic terms). Apart from literal cooking, cooking up word charades is usually even more fun. I also collect football jerseys, support Legia Warsaw & Everton F.C., and am supported by Fąfel the Bernese Mountain Dog.

<div class="section-image">
  <img src="/images/image.JPG" alt="Graffiti">
  <figcaption>Banksy goes Platonic in my neighbourhood in Warsaw, which actually looks nothing like above (cue stereotype about Eastern Europe anyway)</figcaption>
</div>
